...
//       {/* 🔹 Top Bar (Desktop: everything in one row) */}
...
//           {[FiUser, FiHeart, FiShoppingCart].map((Icon, index) => (
//             <div
//               key={index}
...
//             >
//               <Icon className="text-[#017D03] group-hover:text-white text-lg" />
//             </div>
//           ))}
//         </div>
//       </div>
...
//             <div
//               key={index}
//               className="w-8 h-8 flex items-center justify-center rounded-full bg-white hover:bg-[#FF9C00] transition-all cursor-pointer group"
//             >
//               <Icon className="text-[#017D03] group-hover:text-white text-base" />
//             </div>
//           ))}
//         </div>
//       </div>
...
//       <nav className="hidden md:flex items-center justify-center relative bg-[#017D03] text-white px-12 py-3">
//         <div className="flex items-center space-x-10 text-lg font-semibold">
//           {["Home", "Shop", "Well Being", "Contact"].map((link) => (
//             <a key={link} href="#" className="hover:text-[#FF9C00] transition">
//               {link}
//             </a>
//           ))}
//         </div>
...
//       {menuOpen && (
//         <>
//           {/* Background Overlay (dim the rest) */}
//           <div
...
//           <div className="fixed mt-4 right-0 top-[115px] w-[50vw] h-[50vh] bg-[#017D03] text-white p-6 rounded-l-3xl shadow-2xl z-40 animate-slideIn md:hidden">
...
// working page for fully responsive
...
//                       Login
//                     </button>
//                     <button className="block w-full text-left px-3 py-2 hover:bg-[#FF9C00]/20 rounded-md">
//                       Sign Up
//                     </button>
//                   </>
//                 ) : (
